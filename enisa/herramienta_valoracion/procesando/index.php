...
<html lang="es">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Gracias | Lean Finance</title>
        <meta http-equiv="X-UA-Compatible" content="IE=edge">
        <meta content="width=device-width, initial-scale=1.0" name="viewport" />
        <meta http-equiv="Content-type" content="text/html; charset=utf-8">
        <meta content="Dirección financiera outsourcing, valoraciones de empresa, planes financieros y de viabilidad y consultoría y asesoramiento de negocio." name="description" />
        ...
        <!-- Google Tag Manager -->
            ...
            })(window,document,'script','dataLayer','GTM-55FHQHV');</script>
    ...
    <body class="c-layout-header-fixed c-layout-header-mobile-fixed">
        <!-- Google Tag Manager (noscript) -->
            <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-55FHQHV"
                ...
                <div class="container">
                    ...
                    <div class="c-navbar-wrapper clearfix">
                        ...
                        <form class="c-quick-search" action="#">
                            <input type="text" name="query" placeholder="Escribe para buscar..." value="" class="form-control" autocomplete="off">
